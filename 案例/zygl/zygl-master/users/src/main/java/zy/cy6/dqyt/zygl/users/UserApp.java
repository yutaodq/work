package zy.cy6.dqyt.zygl.users;
...
import zy.cy6.dqyt.zygl.infra.config.InfrastructureConfig;
import zy.cy6.dqyt.zygl.query.config.QueryConfig;
...
@Import({InfrastructureConfig.class, QueryConfig.class })
