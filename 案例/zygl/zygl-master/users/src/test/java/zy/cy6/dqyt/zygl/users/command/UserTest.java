...
import zy.cy6.dqyt.zygl.api.users.UserAuthenticatedEvent;
import zy.cy6.dqyt.zygl.api.users.UserCreatedEvent;
import zy.cy6.dqyt.zygl.api.users.UserId;
import zy.cy6.dqyt.zygl.users.util.DigestUtils;
...
public class UserTest {
    ...
    public UserTest(UserId userId, String username, String name, String password) {
