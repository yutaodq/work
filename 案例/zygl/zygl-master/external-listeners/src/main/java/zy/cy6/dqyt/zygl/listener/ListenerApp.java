package zy.cy6.dqyt.zygl.listener;
//package zy.cy6.dqyt.zygl.listener;
//
...
//    private static final Logger log = LoggerFactory.getLogger(ListenersApp.class);
///*
// * Environment 环境变量
...
//
//    public ListenersApp(Environment env) {
//        this.env = env;
//    }
//
//	/**
...
//        SpringApplication app = new SpringApplication(ListenersApp.class);
