...
import zy.cy6.dqyt.zygl.query.transaction.repositories.TransactionQueryRepository;
 ...
 */
//@Component
public class Oracle11DBInit extends BaseDBInit {

    private final static Logger logger = LoggerFactory.getLogger(Oracle11DBInit.class);
    ...
    @Autowired
    public Oracle11DBInit(CommandBus commandBus,
