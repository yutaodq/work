package zy.cy6.dqyt.zygl.webui;
...
public class ZyglApp {
    private static final Logger log = LoggerFactory.getLogger(ZyglApp.class);
/*
 * Environment 环境变量
 ...
 */
    ...
    public ZyglApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ZyglApp.class);
