package zy.cy6.dqyt.zygl.query;
...
public class UsersQueryApp {
    private static final Logger log = LoggerFactory.getLogger(UsersQueryApp.class);
/*
 * Environment 环境变量
 ...
 */
    ...
    public UsersQueryApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(UsersQueryApp.class);
