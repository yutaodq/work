...
import zy.cy6.dqyt.zygl.api.company.OrderBookAddedToCompanyEvent;
import zy.cy6.dqyt.zygl.api.orders.trades.AbstractOrderPlacedEvent;
import zy.cy6.dqyt.zygl.api.orders.trades.BuyOrderPlacedEvent;
import zy.cy6.dqyt.zygl.api.orders.trades.OrderBookId;
import zy.cy6.dqyt.zygl.api.orders.trades.OrderId;
import zy.cy6.dqyt.zygl.api.orders.trades.SellOrderPlacedEvent;
...
import zy.cy6.dqyt.zygl.query.tradeexecuted.TradeExecutedEntry;
import zy.cy6.dqyt.zygl.query.tradeexecuted.repositories.TradeExecutedQueryRepository;
...
public class OrderBookListener {
    ...
    public void handleOrderBookAddedToCompanyEvent(OrderBookAddedToCompanyEvent event) {
        ProductEntryLx companyEntry = companyRepository.findOne(event.getCompanyId().toString());
