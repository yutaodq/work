...
export class ProductFormGroup extends FormGroup {
  ...
  constructor() {
    super({
      ...
      // gg: new FormControl(''),
      // xh: new FormControl(''),
      name: new ProductFormControl('工具名称', 'name', '', Validators.compose([Validators.required, Validators.minLength(3)])),
      gg: new ProductFormControl('规格', 'gg', '', Validators.required),
      xh: new ProductFormControl('型号', 'xh', '', Validators.required),
    });
  }
