...
export class ProductService {
  ...
  // private resourceSearchUrl = SERVER_API_URL + 'api/_search/productEntities';
    ...
    create(product: IProductEntity): Observable<EntityResponseType> {
        return this.http.post<IProductEntity>(this.resourceUrl, product, { observe: 'response' });
    }

    update(product: IProductEntity): Observable<EntityResponseType> {
        return this.http.put<IProductEntity>(this.resourceUrl, product, { observe: 'response' });
    }
  ...
  query(req?: any): Observable<EntityArrayResponseType> {
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IProductEntity[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
