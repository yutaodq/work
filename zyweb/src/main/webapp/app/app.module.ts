...
import {ZyxtMainComponent, FooterComponent, NavbarComponent, ErrorComponent, PageRibbonComponent} from './layouts';
...
@NgModule({
  ...
  declarations: [
    ZyxtMainComponent, FooterComponent, NavbarComponent, ErrorComponent, PageRibbonComponent
  ],
  providers: [
