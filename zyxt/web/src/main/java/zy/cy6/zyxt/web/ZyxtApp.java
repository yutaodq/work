...
//    excludeFilters = {
//      @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SameA.class)
//    })
@ComponentScan(
        basePackages = {"zy.cy6.zyxt"}
        )
...
public class ZyxtApp {
  ...
  /**
   * Initializes common . 被@PostConstruct修饰的方法会在服务器加载Servlet的时候运行， 并且只会被服务器调用一次，类似于Serclet的inti()方法。
