...
/** author: 小宇宙 date: 2018/4/5 https://github.com/sherlockgit/SpringBoot-Shrio-jpa */
@Service
@Transactional
@Slf4j
public class SysUserServiceImpl implements SysUserService {
  ...
  @Autowired SysUserRoleRepository sysUserRoleRepository;
        ...
        new Specification<SysUser>() {
          ...
          public Predicate toPredicate(
            ...
            if (StringUtils.isNoneBlank(name)) {
              predicate.add(
                  criteriaBuilder.like(root.get("name").as(String.class), JPAUtil.like(name)));
            }
  ...
  public R updateUser(SysUserFrom sysUserFrom) {
    ...
    /*判断用户有没有修改账号*/
    if (!sysUserRepository
        .getOne(sysUserFrom.getId())
        .getAccount()
        .equals(sysUserFrom.getAccount())) {
      /*用户修改账号*/
